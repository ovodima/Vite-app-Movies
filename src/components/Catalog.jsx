  ...
  return (
    <Canvas dpr={[1, 1.5]} camera={{ fov: 70, position: [0, 0, 100] }}>
      <Suspense fallback={null}>
        ...
        <fog attach="fog" args={['#06142E', 0, 10]} />
  ...
  return (
    <group ref={ref} {...props}>
      <RoundedBox
        ...
        <meshStandardMaterial color="#06142E" metalness={0.9} roughness={0.5} envMapIntensity={2} />
        <mesh raycast={() => null} scale={[1, 0.93, 0.9]} position={[0, 0, 0.2]}>
          <boxGeometry />
          <meshBasicMaterial color="#06142E" toneMapped={false} />
        </mesh>
        <Image raycast={() => null} ref={image} scale={[0.97, 0.97, 0.90]} position={[0, 0, 0.7]} url={url} />
      </RoundedBox>
    </group>
  )
}